...
INSERT INTO app_user (app_user_name, app_user_first_name, app_user_pseudo, app_user_email, app_user_password, app_user_phone, created_date, last_modified_date, account_type_id) VALUES
                 ('Dupont', 'Jean', 'jdupont', 'jean.dupont@mail.com', 'password', '0600000001', now(), now(), 3),
                 ('Martin', 'Claire', 'cmartin', 'claire.martin@mail.com', 'password', '0600000002', now(), now(), 4),
                 ('Bernard', 'Luc', 'lbernard', 'luc.bernard@mail.com', 'password', '0600000003', now(), now(), 3),
                 ('Petit', 'Sophie', 'spetit', 'sophie.petit@mail.com', 'password', '0600000004', now(), now(), 5),
                 ('Robert', 'Hugo', 'hrobert', 'hugo.robert@mail.com', 'password', '0600000005', now(), now(), 3),
                 ('Moreau', 'Emma', 'emmoreau', 'emma.moreau@mail.com', 'password', '0600000006', now(), now(), 4),
                 ('Fischer', 'Karl', 'kfischer', 'karl.fischer@mail.com', 'password', '0600000007', now(), now(), 5),
                 ('Schmidt', 'Anna', 'aschmidt', 'anna.schmidt@mail.com', 'password', '0600000008', now(), now(), 5),
                 ('Lopez', 'Carlos', 'clopez', 'carlos.lopez@mail.com', 'password', '0600000009', now(), now(), 3),
                 ('Gomez', 'Maria', 'mgomez', 'maria.gomez@mail.com', 'password', '0600000010', now(), now(), 4),
                 ('Rossi', 'Marco', 'mrossi', 'marco.rossi@mail.com', 'password', '0600000011', now(), now(), 5),
                 ('Bianchi', 'Luca', 'lbianchi', 'luca.bianchi@mail.com', 'password', '0600000012', now(), now(), 3),
                 ('Smith', 'Emily', 'esmith', 'emily.smith@mail.com', 'password', '0600000013', now(), now(), 3),
                 ('Johnson', 'David', 'djohnson', 'david.johnson@mail.com', 'password', '0600000014', now(), now(), 5),
                 ('Brown', 'Sarah', 'sbrown', 'sarah.brown@mail.com', 'password', '0600000015', now(), now(), 4),
                 ('Wilson', 'Jack', 'jwilson', 'jack.wilson@mail.com', 'password', '0600000016', now(), now(), 4),
                 ('Miller', 'Ava', 'amiller', 'ava.miller@mail.com', 'password', '0600000017', now(), now(), 4),
                 ('Anderson', 'Noah', 'nanderson', 'noah.anderson@mail.com', 'password', '0600000018', now(), now(), 5),
                 ('Thompson', 'Lily', 'lthompson', 'lily.thompson@mail.com', 'password', '0600000019', now(), now(), 3),
                 ('Campbell', 'Oliver', 'ocampbell', 'oliver.campbell@mail.com', 'password', '0600000020', now(), now(), 4),
                 ('Durand', 'Paul', 'pdurand', 'paul.durand@mail.com', 'password', '0600000021', now(), now(), 3),
                 ('Leroy', 'Camille', 'cleroy', 'camille.leroy@mail.com', 'password', '0600000022', now(), now(), 4),
                 ('Faure', 'Mathieu', 'mfaure', 'mathieu.faure@mail.com', 'password', '0600000023', now(), now(), 5),
                 ('Gauthier', 'Julie', 'jgauthier', 'julie.gauthier@mail.com', 'password', '0600000024', now(), now(), 4),
                 ('Leclerc', 'Antoine', 'aleclerc', 'antoine.leclerc@mail.com', 'password', '0600000025', now(), now(), 3),
                 ('Morel', 'Chloe', 'cmorel', 'chloe.morel@mail.com', 'password', '0600000026', now(), now(), 5),
                 ('Girard', 'Thomas', 'tgirard', 'thomas.girard@mail.com', 'password', '0600000027', now(), now(), 5),
                 ('Perrin', 'Laura', 'lperrin', 'laura.perrin@mail.com', 'password', '0600000028', now(), now(), 4),
                 ('Renaud', 'Nicolas', 'nrenaud', 'nicolas.renaud@mail.com', 'password', '0600000029', now(), now(), 3),
                 ('Lemoine', 'Sophie', 'slemoine', 'sophie.lemoine@mail.com', 'password', '0600000030', now(), now(), 5);
