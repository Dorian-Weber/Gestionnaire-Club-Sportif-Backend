...
INSERT INTO app_user (app_user_name, app_user_first_name, app_user_pseudo, app_user_email, app_user_password, app_user_phone, created_date, last_modified_date, account_type_id) VALUES
                 ...
                 ('Durand', 'Paul', 'pdurand', 'paul.durand@mail.com', 'password', '0600000021', now(), now(), 2),
                 ('Leroy', 'Camille', 'cleroy', 'camille.leroy@mail.com', 'password', '0600000022', now(), now(), 2),
                 ('Faure', 'Mathieu', 'mfaure', 'mathieu.faure@mail.com', 'password', '0600000023', now(), now(), 2),
                 ('Gauthier', 'Julie', 'jgauthier', 'julie.gauthier@mail.com', 'password', '0600000024', now(), now(), 2),
                 ('Leclerc', 'Antoine', 'aleclerc', 'antoine.leclerc@mail.com', 'password', '0600000025', now(), now(), 2),
                 ('Morel', 'Chloe', 'cmorel', 'chloe.morel@mail.com', 'password', '0600000026', now(), now(), 2),
                 ('Girard', 'Thomas', 'tgirard', 'thomas.girard@mail.com', 'password', '0600000027', now(), now(), 2),
                 ('Perrin', 'Laura', 'lperrin', 'laura.perrin@mail.com', 'password', '0600000028', now(), now(), 2),
                 ('Renaud', 'Nicolas', 'nrenaud', 'nicolas.renaud@mail.com', 'password', '0600000029', now(), now(), 2),
                 ('Lemoine', 'Sophie', 'slemoine', 'sophie.lemoine@mail.com', 'password', '0600000030', now(), now(), 2);
